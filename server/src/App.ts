...
import { RetrieveFilteredApplicationsController } from './controllers/applications/RetrieveFilteredApplications';
...
registerController(app, RetrieveApplicationsController);
registerController(app, RetrieveFilteredApplicationsController);
